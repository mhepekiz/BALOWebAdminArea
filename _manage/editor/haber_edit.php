...
return $ayx;
	...
	$yayin = mysql_real_escape_string($yayin);
		...
		//	$baslik = addslashes($baslik);
			...
			mysql_query("update haberler set manset='$manset', lang='$dil', kategori='1', tarih='$orderdate', yayin='$medyam', baslik='$baslik', spot='$spot', metin='$metin', zaman='$zaman', editor='$e_uname' where id='$remhid'") or die("DB Error");
...
$ressim2 = resim($filename2_name);
 ...
 if($filename2){
	...
	mysql_query("update haberler set foto_thumb='$thumb_sql_name' where id='$remhid'") or die("DB Err");
