...
$ressim = resim($filename_name);
  ...
  if($filename){
	...
	mysql_query("insert into havuz (foto_1, foto_2, foto_3, zaman, editor) values ('$home_sql_name', '$detail_sql_name', '$large_sql_name', '$tarih', '$e_uname')") or die("DB Err");
	
//echo"$home_sql_name//////// $large_sql_name";
	        

  echo'<a href="http://www.balo.org.tr'.$large_sql_name.'"><font face="Arial" style="font-size:12px">http://www.balo.org.tr'.$large_sql_name.'</a>';
