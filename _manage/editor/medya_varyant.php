...
return $ayx;
	...
	$yayin = mysql_real_escape_string($yayin);
		...
		//	$baslik = addslashes($baslik);
			...
			mysql_query("insert into medyalang (haberid, lang, kategori, baslik, spot, metin, zaman, editor) values ('$remhid','$dil','2','$baslik','$spot','$metin','$zaman','$e_uname')")or die("DB Error");
			

     
$proc = "Kupür eklendi ($baslik)...";



echo "<script> alert(\"Kupür eklendi ($baslik)!\"); </script>";
	...
	mysql_query("delete from medyalang where id='$remhix'");		
		
	  
$proc = "Kupur silindi ($remhid)...";



echo "<script> alert(\"Kupur silindi ($remhid)!\"); </script>";
