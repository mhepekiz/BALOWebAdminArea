<?
		...
		$galeri_check = mysql_query("select id, baslik from haberler where id='$galeri'");
		list($idd, $haberim) = mysql_fetch_row($galeri_check);
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="20%"><font face="Arial, Helvetica, sans-serif" style="font-size:12px">Galeri</font></td>
    <td width="1"><font face="Arial, Helvetica, sans-serif" style="font-size:12px">:</font></td>
    <td><font face="Arial, Helvetica, sans-serif" style="font-size:12px"><?=$haberim?></font></td>
  </tr>
</table>
...
$get_galf = mysql_query("select id,foto_1,zaman from galeri_foto where galeriid='$galeri' order by id desc limit 100");
...
echo'	<tr>
      ...
      <td bgcolor="'.$bgc.'" nowrap align="center"><img src="'.$foto.'" border="0"></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"  valign="top"><a href="/admin/_manage/editor/galeri_addphoto.php?ac_t=del&remhid='.$fid.'&galeri='.$galeri.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
