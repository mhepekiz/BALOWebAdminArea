...
return $ayx;
	...
	$yayin = mysql_real_escape_string($yayin);
		...
		//	$baslik = addslashes($baslik);
			...
			mysql_query("insert into haberler (lang, kategori, tarih, yayin, baslik, spot, metin, foto_1, foto_2, foto_3, zaman, editor) values ('$dil','2','$orderdate','$medyam','$baslik','$spot','$metin','1','2','3','$zaman','$e_uname')")or die("DB Error");
...
echo "<script> alert(\"Haber eklendi ($baslik)!\"); </script>";
	...
	mysql_query("delete from haberler where id='$remhid' and kategori='2'");		
