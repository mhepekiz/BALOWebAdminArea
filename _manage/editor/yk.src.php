...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/yk.php" >
...
<tr>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea cols="80" name="metin" rows="5">TR</textarea>
</td>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea cols="80" name="metinen" rows="5">EN</textarea>
</td>
