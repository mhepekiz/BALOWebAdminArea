...
return $ayx;
	...
	$yayin = mysql_real_escape_string($yayin);
		...
		//	$baslik = addslashes($baslik);
			...
			mysql_query("update haberler set lang='$dil', tarih='$orderdate', yayin='$medyam', baslik='$baslik', spot='$spot', metin='$metin', zaman='$zaman', editor='$e_uname' where id='$remhid'")or die("DB Error");
