...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/medyalogo.php" >
...
<tr>
      ...
      <td width="100%"><input type="text" name="medya" size="70"></td>
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/medyalogo_edit.php?ac_t=update&remhid='.$mid.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/medyalogo.php?ac_t=del&remhid='.$mid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
