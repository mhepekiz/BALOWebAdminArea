...
$ressim = resim($filename_name);
  ...
  if($filename){
	...
	mysql_query("insert into galeri_foto (galeriid, foto_1, foto_2, foto_3, zaman) values ('$galeri', '$home_sql_name', '$detail_sql_name', '$large_sql_name', '$tarih')") or die("DB Err");
