						...
						<td valign="top" #000000><!--Start Contents-->
							...
							<tr>
								...
								<table id="table11" cellSpacing="0" cellPadding="0" width="100%" border="0">
									<tr>
										<td #000000>
										<font face="Arial" size="4">Kategori 
										Reklamlarý</font></td>
										<td #000000>
										<p align="right">
...
<fieldset>
<legend>Kategori Reklamý Ekleme Formu</legend>

<table border="0" width="100%" id="table12" cellspacing="0" cellpadding="4">
	<tr>
		<td align="left">
		<form action="/admin/_manage/reklamlar/kategori_reklamlari.php" name="reklamekle">
		...
		zorundadýr.</td>
			...
			<tr>
				...
				<td>:</td>
				<td width="100%">
				<input style="background-color: #e8e8e8" maxLength="50" size="7" name="catof">
				<a onclick="window.open('/admin/_manage/_pages/reklamlar/kategorisecekle.php','502L','toolbar=no,width=450,height=500,left=0,top=0,status=no,scrollbars=yes,resize=no');return false" tabIndex="4" style="color: #0240a3" href="#">
...
<table border="0" width="100%" id="table1" cellpadding="2" cellspacing="1">
	<tr>
		<td colspan="5">Sistemde yer alan kategori bannerlarý aþaðýdaki gibidir.</td>
	</tr>
	<tr>
		<td nowrap bgcolor="#B6CDF3" width="100%">Banner Adý</td>
		<td nowrap bgcolor="#85ABEB">Kategori</td>
...
$get_banner_cat = mysql_query("select id,catid,banner,status,tarih,editor from adv_cat order by catid");
while(list($bid,$catid,$banner,$b_durum,$tarih,$b_editor)=mysql_fetch_row($get_banner_cat)){

$get_cat_ad = mysql_query("select ad from kategori where id='$catid'");
list($cat_ad)=mysql_fetch_row($get_cat_ad);
...
echo '
	<tr>
		...
		<td bgcolor="'.$bgc.'"  nowrap>'.$cat_ad.'</td>
		...
		<font size="1">
		<a href="/admin/_manage/reklamlar/kategori_reklamlari.php?ac_t=status&bid='.$bid.'&nd='.$new_d.'&banner='.$banner.'"><img border="0" src="/admin/_media/'.$b_img.'" width="16" height="16"></a>&nbsp;&nbsp;
		<a href="/admin/_manage/reklamlar/kategori_reklamlari.php?ac_t=del&bid='.$bid.'&banner='.$banner.'"><img border="0" src="/admin/_media/delete.gif" width="15" height="15"></a></font></td>
	</tr> ';
}
?>
</table>
