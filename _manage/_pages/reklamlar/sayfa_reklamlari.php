						...
						<td valign="top" #000000><!--Start Contents-->
							...
							<tr>
								...
								<table id="table11" cellSpacing="0" cellPadding="0" width="100%" border="0">
									<tr>
										<td #000000>
										<font face="Arial" size="4">Menü Altý Reklamlarý</font></td>
										<td #000000>
										<p align="right">
...
<fieldset>
<legend>Menü Altý Reklamlarý</legend>

<table border="0" width="100%" id="table12" cellspacing="0" cellpadding="4">
	<tr>
		<td align="left">
		<form action="/admin/_manage/reklamlar/sayfa_reklamlari.php">
		<input type="hidden" name="ac_t" value="add">
		<table border="0" width="100%" id="table13" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="3">Menü altý reklamlarý sitede kategoriler menüsü 
				altýnda kalan alanda gösterilir. 170x148 boyutunda olmak 
		zorundadýr.</td>
			</tr>
			<tr>
...
<table border="0" width="100%" id="table1" cellpadding="2" cellspacing="1">
	<tr>
		<td colspan="4">Sistemde yer alan menü altý reklamlarý aþaðýdaki gibidir.</td>
	</tr>
	<tr>
...
$get_banner_page = mysql_query("select id,banner,status,tarih,editor from adv_page order by locale");
while(list($bid,$banner,$b_durum,$tarih,$b_editor)=mysql_fetch_row($get_banner_page)){
...
echo '
	<tr>
		...
		<font size="1">
		<a href="/admin/_manage/reklamlar/sayfa_reklamlari.php?ac_t=status&bid='.$bid.'&nd='.$new_d.'&banner='.$banner.'"><img border="0" src="/admin/_media/'.$b_img.'" width="16" height="16"></a>&nbsp;&nbsp;
		<a href="/admin/_manage/reklamlar/sayfa_reklamlari.php?ac_t=del&bid='.$bid.'&banner='.$banner.'"><img border="0" src="/admin/_media/delete.gif" width="15" height="15"></a></font></td>
	</tr> ';
}
?>
</table>
