<?
$gcp = mysql_query("select metin,image from comprofile where id='1'");
						...
						<td valign="top" style="font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif; font-size: 11px"><!--Start Contents-->
							...
							<tr>
								...
								<table border="0" width="100%" id="table11" cellspacing="0" cellpadding="0">
									<tr>
										<td><font face="Arial" size="4">Þirket 
										Profili</font></td>
										<td>
										<p align="right">
...
<legend>Þirket Profili Ekleme / Düzenleme</legend>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>
		<table border="0" id="table10" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td><form method="POST" enctype="multipart/form-data" action="/admin/_manage/metin/profil.php">
<input type="hidden" name="ac_t" value="add">
  <table border="0" cellpadding="4" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">    
    <tr>
      <td valign="top" nowrap><font face="Arial">Þirket Profili</font><span lang="en">&nbsp;&nbsp;&nbsp;</font></span></font></td>
    ...
    <tr>
      ...
      <input type="submit" value="Þirket Profilini Güncelle" name="B1"></td>
    </tr>
  </table>
</form></td>
			</tr>
