...
<legend>Editor Bilgi Güncelleme Formu</legend>
<?
$get_admin_det = mysql_query("select name,email,uname,pass from editors where id='$my_eid'");
list($admin_name,$admin_email,$admin_uname,$admin_pass)=mysql_fetch_row($get_admin_det);
?>
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table1">
	<tr>
		<td>Aþaðýdaki formu kullanarak bilgilerde 
		güncelleme yapabilirsiniz.</td>
	</tr>
	<tr>
		<td>
		<form method="POST" action="/admin/_manage/admin/info.php">
			<table border="0" cellpadding="2" cellspacing="0" width="500" id="table2">
				...
				<tr>
					...
					<td>:</td>
					<td width="100%"><input type="text"  disabled name="admin_uname" size="13" value="<?=$admin_uname?>"></td>
				</tr>
				<tr>
					<td nowrap>Þifre</td>
					<td>:</td>
