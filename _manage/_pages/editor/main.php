...
<legend>Editör Ekleme Formu</legend>

<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>

		<div class="paging">			

<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/main.php" onSubmit="return bosvarmi(this)">
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td width="48%" height="25"><input type="text" name="email" size="70"></td>
    ...
    <tr>
      ...
      <td width="48%"><input type="text" name="kullanici" size="10"></td>
    ...
    <tr>
      ...
      <td width="48%"><input type="text" name="sifre" size="10"></td>
    ...
    <tr>
      ...
      <td width="48%"><input type="text" name="sifreonay" size="10"></td>
    ...
    <tr>
      ...
      <td width="48%"><select size="1" name="yetki">
		<option value="9999">Editör</option>
		<option value="151">Yönetici</option>
		</select></td>
...
<legend>Sistemdeki Editörler</legend>
...
<table border="0" width="100%" id="table10" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<td nowrap colspan="4">Mevcut editörler içinde arama yapabilirsiniz...</td>
		...
		<form method="POST" action="/admin/_manage/metin/haber.php" name="haber_ara">
			...
			<table border="0" width="100%" id="table11" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="100%">&nbsp;<span lang="en">&nbsp;&nbsp;&nbsp;</span><a href="/admin/_manage/editor/main.php"><img border="0" src="/admin/_media/showall.gif" width="16" height="16"> 
...
$get_news = mysql_query("select id,name,email,yetki,zaman from editors $newsq");

while(list($yid,$yad,$yemail,$yet,$zam)=mysql_fetch_row($get_news)){
...
echo'	<tr>
		...
		<td bgcolor="'.$bgc.'" nowrap width="100%">'.$yad.'</a></td>
		
		<td bgcolor="'.$bgc.'" nowrap align="center">'.$yemail.'</td>

		<td bgcolor="'.$bgc.'" nowrap align="center">'.$zam.'</td>		
		
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/main.php?ac_t=del&remhid='.$yid.'"><img src="/admin/_media/delete.gif" border="0"></a></td>
