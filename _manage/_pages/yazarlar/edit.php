...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/yazarlar/edit.php" onSubmit="return bosvarmi(this)">
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td align="left" valign="top">Yazar</td>
		...
		<? $yazi_al = mysql_query("select id, yazid, baslik, spot, metin from klist_koseyazilari where id='$artid'");
		   		list($y_id, $yazid, $y_baslik, $y_spot, $y_metin)=mysql_fetch_row($yazi_al);
    ...
    <tr>
      ...
      <td width="93%"><input type="text" name="baslik" size="70" value="<?=$y_baslik?>"></td>
    ...
    <tr>
      ...
      <td width="93%"><textarea rows="2" name="spot" cols="60"><?=$y_spot?></textarea></td>
...
<textarea name="metin" cols="54" rows="7"><?=$y_metin?></textarea>
    ...
    <tr>
      ...
      <td width="93%"><input type="submit" value="Yazý Güncelle" name="B1"></td>
  ...
  <input type="hidden" name="artid" value="<?=$y_id?>">
