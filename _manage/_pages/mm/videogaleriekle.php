...
<legend>Video Galeri Ekleme Formu</legend>

<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>

		<div class="paging">			

<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/mm/videogaleriekle.php" onSubmit="return bosvarmi(this)">
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td width="35%" rowspan="6" valign="top">
    ...
    <tr>
      ...
      <td width="48%"><input type="text" name="galeriadi" size="70"></td>
    ...
    <tr>
      ...
      <td width="48%"><input type="submit" value="Galeri Ekle" name="B1"></td>
...
$get_news = mysql_query("select id,baslik,zaman from klist_vgaleri $newsq");
...
echo'	<tr>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/mm/fotogaleriekle.php?ac_t=del&remhid='.$yid.'"><img src="/admin/_media/delete.gif" border="0"></a></td>
