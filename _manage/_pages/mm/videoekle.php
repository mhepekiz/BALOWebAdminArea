...
<table border="0" id="table14" cellspacing="0" cellpadding="3" width="400">
	...
	<tr>
		...
		<td align="center" width="25%">	
		<font style="font-size:11px"><a href="/admin/_manage/mm/video.php">Fotoðraf Ekle</a></font></td>
		<td align="center" width="25%">	
		<font style="font-size:11px">
...
<div class="paging">
<form method="POST" action="/admin/_manage/mm/videoekle.php" name="urun_ozellik_secim">
	<table border="0" width="100%" id="table12" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<?
				$get_cars = mysql_query("select id,baslik from klist_vgaleri order by baslik");
...
<table border="0" width="100%" id="table13" cellspacing="0" cellpadding="2">
	...
	<tr>
		<td width="22%">
	      <form method="POST" enctype="multipart/form-data" action="/admin/_manage/mm/videoekle.php">
	...
	<tr>
		...
		<td width="78%">
	      <input type="text" name="videoyolu" size="70"></td>
	</tr>
	...
	<tr>
      ...
      <input type="submit" value="Video Ekle" name="B2" style="font-size: 10px"></td></form>
	</tr>
	<tr>
		<td colspan="2"><hr color="#000000" size="1"></td>
	</tr>
	<tr>
		<td colspan="2">Mevcut Videolar</td>
	</tr>
	<tr>
		<td colspan="2">
...
<?
$ir = 0;
$get_pics = mysql_query("select id,galeriid,aciklama,resim_2 from klist_videolar where galeriid ='$pro_d'");
...
Echo '			<tr>
				...
				<td noWrap align="middle" bgColor="'.$bgc.'"><a href="javascript:confirmDelete(\'/admin/_manage/galeri/videoekle.php?ac_t=delete&pro_d='.$pro_d.'&video='.$rid.'&urun='.$u_id.'\');">
