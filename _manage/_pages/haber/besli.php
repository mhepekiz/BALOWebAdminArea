...
<legend>Sistemdeki 5li Haberleri</legend>
...
<table border="0" width="100%" id="table10" cellpadding="5" cellspacing="1">
	...
	<tr>
		...
		<td nowrap width="1" bgcolor="#FF6C00" align="left"><b>Haber Siralama</b></td></tr>
...
{
?>  
	<li id="editor_<?=$id?>"><img src="/_media/tud.png" border="0" />&nbsp;&nbsp;<?=$editor?></li>
<?
}
?>
</ul>
...
function liste_sirala()
{
	...
	new Ajax.Request('kayit5.php', options);
}
